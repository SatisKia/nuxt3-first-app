...
export default defineNuxtPlugin(nuxtApp => {
  nuxtApp.provide('myCookie', myCookie);
});

// 型定義
declare module '#app' { interface NuxtApp { $myCookie: MyCookie } }
declare module '@vue/runtime-core' { interface ComponentCustomProperties { $myCookie: MyCookie } }
